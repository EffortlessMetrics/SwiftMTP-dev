class Swiftmtp < Formula
  ...
  homepage "https://github.com/EffortlessMetrics/SwiftMTP"
  version "1.0.0"

  if Hardware::CPU.arm?
    url "https://github.com/EffortlessMetrics/SwiftMTP/releases/download/v1.0.0/swiftmtp-macos-arm64.tar.gz"
