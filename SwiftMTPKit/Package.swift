...
let package = Package(
  ...
  targets: [
    ...
    .testTarget(name: "TransportTests", dependencies: ["SwiftMTPTransportLibUSB", "SwiftMTPTransportIOUSBHost", "SwiftMTPTestKit", "CLibusb"]),
    .testTarget(
      name: "BDDTests",
      dependencies: [
    ...
    .testTarget(
      name: "PropertyTests",
      dependencies: [
        "SwiftMTPCore", "SwiftMTPIndex", "SwiftMTPSync", "SwiftMTPObservability", "SwiftMTPStore",
        "SwiftMTPQuirks", "SwiftMTPCLI", "MTPEndianCodec", "SwiftCheck",
      ]),
    .testTarget(
      name: "SnapshotTests",
      dependencies: [
    ...
    .testTarget(
      ...
      dependencies: ["MTPEndianCodec", "SwiftMTPCore", "SwiftCheck"],
      exclude: ["Corpus"]),
