...
public final class BDDContext: @unchecked Sendable {
    ...
    public func verify(_ condition: Bool, _ message: String) throws {
        if !condition { throw NSError(domain: "BDDFailure", code: 1, userInfo: [NSLocalizedDescriptionKey: message]) }
    }
}
...
public struct MTPSnapshot: Codable, Sendable {
    ...
    public init(timestamp: Date, deviceInfo: MTPDeviceInfo, storages: [MTPStorageInfo], objects: [MTPObjectInfo]) {
