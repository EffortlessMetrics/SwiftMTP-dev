...
public struct DeviceIdentitySignals: Sendable {
    ...
    public init(vendorId: UInt16?, productId: UInt16?, usbSerial: String?, mtpSerial: String?, manufacturer: String?, model: String?) {
        self.vendorId = vendorId; self.productId = productId
        self.usbSerial = usbSerial; self.mtpSerial = mtpSerial
