...
public final class NullPersistenceProvider: MTPPersistenceProvider, LearnedProfileStore,
  ProfilingStore, SnapshotStore, SubmissionStore, TransferJournal, ObjectCatalogStore
{
  public init() {}
