...
struct GitHubIntegration {
  ...
  static func generatePRBody(
    deviceName: String, vendorId: String, productId: String, bundlePath: String
  ) -> String {
    return """
      ## Device Submission
  ...
  static func generateCommitMessage(deviceName: String, vendorId: String, productId: String)
    -> String
  {
  ...
  private static func runCommand(_ command: String, arguments: [String]) async throws -> String {
    ...
    if process.terminationStatus != 0 {
      ...
      throw GitHubError.commandFailed(
        "Command '\(command) \(arguments.joined(separator: " "))' failed: \(errorMessage)")
    }
