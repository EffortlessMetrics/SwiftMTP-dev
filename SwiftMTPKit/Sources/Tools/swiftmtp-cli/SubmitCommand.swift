    ...
    static func run(bundlePath: String, gh: Bool) async -> ExitCode {
        ...
        do {
            ...
            if gh {
                ...
                let branchName = GitHubIntegration.generateBranchName(deviceName: deviceName, vendorId: vid, productId: pid)
                ...
                let commitMsg = GitHubIntegration.generateCommitMessage(deviceName: deviceName, vendorId: vid, productId: pid)
                ...
                let prBody = GitHubIntegration.generatePRBody(deviceName: deviceName, vendorId: vid, productId: pid, bundlePath: bundlePath)
