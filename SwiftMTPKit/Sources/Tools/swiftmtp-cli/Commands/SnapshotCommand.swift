...
struct SnapshotCommand {
    static func run(flags: CLIFlags, args: [String]) async {
        ...
        do {
            ...
            let sanitizedManufacturer = info.manufacturer.replacingOccurrences(of: "[^a-zA-Z0-9]", with: "_", options: .regularExpression)
            let sanitizedModel = info.model.replacingOccurrences(of: "[^a-zA-Z0-9]", with: "_", options: .regularExpression)
