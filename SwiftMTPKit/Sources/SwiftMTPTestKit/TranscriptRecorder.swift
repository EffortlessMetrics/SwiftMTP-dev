...
public final class TranscriptRecorder: MTPLink, @unchecked Sendable {
    ...
    public func executeCommand(_ command: PTPContainer) async throws -> PTPResponseResult {
        ...
        try await record("executeCommand", request: TranscriptData(code: command.code, params: command.params)) {
    ...
    public func executeStreamingCommand(
        ...
        try await record(
            ...
            request: TranscriptData(code: command.code, params: command.params, dataSize: dataPhaseLength.map { Int($0) })
        ) {
