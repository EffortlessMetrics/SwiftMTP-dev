...
final class FileProviderCoverageTests: XCTestCase {
    private func makeDomain(_ id: String = "swiftmtp-test-domain") -> NSFileProviderDomain {
        NSFileProviderDomain(identifier: NSFileProviderDomainIdentifier(id), displayName: "SwiftMTP Test")
    }
    ...
    func testDomainEnumeratorItemsAndNoReaderPaths() async throws {
        ...
        let storageEnumerator = DomainEnumerator(deviceId: "device1", storageId: nil, parentHandle: nil, indexReader: reader)
        ...
        storageEnumerator.enumerateItems(for: storageObserver, startingAt: NSFileProviderPage.initialPageSortedByDate as NSFileProviderPage)
        ...
        let objectEnumerator = DomainEnumerator(deviceId: "device1", storageId: 1, parentHandle: nil, indexReader: reader)
        ...
        objectEnumerator.enumerateItems(for: objectObserver, startingAt: NSFileProviderPage.initialPageSortedByDate as NSFileProviderPage)
        ...
        objectEnumerator.enumerateItems(for: emptyObserver, startingAt: NSFileProviderPage.initialPageSortedByDate as NSFileProviderPage)
        await fulfillment(of: [emptyExpectation], timeout: 2.0)
        XCTAssertTrue(emptyObserver.finished)

        let noReaderEnumerator = DomainEnumerator(deviceId: "device1", storageId: nil, parentHandle: nil, indexReader: nil)
        ...
        noReaderEnumerator.enumerateItems(for: noReaderObserver, startingAt: NSFileProviderPage.initialPageSortedByDate as NSFileProviderPage)
    ...
    func testDomainEnumeratorChangesAnchorAndErrorPaths() async throws {
        ...
        let enumerator = DomainEnumerator(deviceId: "device1", storageId: 1, parentHandle: nil, indexReader: reader)
    ...
    func testMTPFileProviderExtensionInjectedCacheAndXPCPaths() async throws {
        throw XCTSkip("Direct NSFileProviderReplicatedExtension execution is unstable in this host test runtime.")
    }
