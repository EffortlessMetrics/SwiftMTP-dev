...
final class QuirksCoverageBoostTests: XCTestCase {
  ...
  func testUserOverrideFromEnvironmentParsesKnownValues() {
    let (override, source) = UserOverride.fromEnvironment([
      "SWIFTMTP_OVERRIDES":
        "maxChunkBytes=2097152,ioTimeoutMs=15000,handshakeTimeoutMs=12000,inactivityTimeoutMs=7000,overallDeadlineMs=90000,stabilizeMs=400,disablePartialRead=true,disablePartialWrite=1,ignored=value,malformed"
    ])
