...
final class DeviceFilterTests: XCTestCase {
    ...
    func testSelectDeviceEmptyList() {
        let outcome = selectDevice([], filter: DeviceFilter(vid: nil, pid: nil, bus: nil, address: nil), noninteractive: false)
    ...
    func testSelectDeviceSingleDeviceNoFilter() {
        ...
        let outcome = selectDevice([device], filter: DeviceFilter(vid: nil, pid: nil, bus: nil, address: nil), noninteractive: false)
    ...
    func testSelectDeviceMultipleDevicesNoFilter() {
        ...
        let outcome = selectDevice([device1, device2], filter: DeviceFilter(vid: nil, pid: nil, bus: nil, address: nil), noninteractive: false)
