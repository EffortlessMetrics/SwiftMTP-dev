...
final class QuirkSystemTests: XCTestCase {
    ...
    func testSchemaBoundsClamping() throws {
        ...
        XCTAssertGreaterThanOrEqual(lowChunk.maxChunkBytes, 131_072, "Chunk size should be clamped to minimum")
        ...
        XCTAssertLessThanOrEqual(highChunk.maxChunkBytes, 16_777_216, "Chunk size should be clamped to maximum")
