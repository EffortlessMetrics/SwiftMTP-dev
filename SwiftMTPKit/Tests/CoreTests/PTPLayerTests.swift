...
final class PTPLayerTests: XCTestCase {
  ...
  func testSupportsOperationWithPartialObject64() {
    ...
    XCTAssertTrue(
      PTPLayer.supportsOperation(PTPOp.getPartialObject64.rawValue, deviceInfo: deviceInfo))
    XCTAssertFalse(
      PTPLayer.supportsOperation(PTPOp.getPartialObject.rawValue, deviceInfo: deviceInfo))
  }
