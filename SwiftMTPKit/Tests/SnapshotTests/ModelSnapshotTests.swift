...
final class ModelSnapshotTests: XCTestCase {
    ...
    func testProbeReceiptPixel7() throws {
        ...
        let summary = MTPDeviceSummary(
            id: MTPDeviceID(raw: "pixel7-4ee1-2A221FDH200G2Q"),
            manufacturer: "Google",
            model: "Pixel 7",
            vendorID: 0x18D1,
            productID: 0x4EE1,
            usbSerial: "2A221FDH200G2Q"
        )
        ...
        interfaceProbe.attempts = [
            ...
            InterfaceAttemptResult(interfaceNumber: 1, score: 8, succeeded: false, durationMs: 120, error: "LIBUSB_ERROR_ACCESS")
        ]
    ...
    func testProbeReceiptOnePlus3T() throws {
        ...
        let summary = MTPDeviceSummary(
            id: MTPDeviceID(raw: "oneplus3t-f003-5dfe2dc2"),
        ...
        interfaceProbe.attempts = [
            ...
            InterfaceAttemptResult(interfaceNumber: 1, score: 0, succeeded: false, durationMs: 5, error: "Mass Storage interface - ignored")
        ]
    ...
    func testProbeReceiptXiaomiMiNote2() throws {
        ...
        testReceipt.capabilities = capabilities
        testReceipt.fallbackResults = fallbackResults
        testReceipt.resolvedPolicy = PolicySummary(from: DevicePolicy(tuning: policy, flags: quirkFlags))
