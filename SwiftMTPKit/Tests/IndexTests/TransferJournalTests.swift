...
struct TransferJournalTests {
    ...
    func testJournalPlaybackFromBeginning() throws {
        ...
        let journalPath = tempDir.appendingPathComponent("test-journal-\(UUID().uuidString).sqlite").path
    ...
    func testJournalPlaybackFromMiddle() throws {
        let tempDir = FileManager.default.temporaryDirectory
        let journalPath = tempDir.appendingPathComponent("test-journal-mid-\(UUID().uuidString).sqlite").path
        defer { try? FileManager.default.removeItem(atPath: journalPath) }
    ...
    func testPartialTransferRecovery() throws {
        let tempDir = FileManager.default.temporaryDirectory
        let journalPath = tempDir.appendingPathComponent("test-recovery-\(UUID().uuidString).sqlite").path
        defer { try? FileManager.default.removeItem(atPath: journalPath) }
        ...
        // Simulate failure
        let testError = NSError(domain: "TestError", code: 1, userInfo: [NSLocalizedDescriptionKey: "Connection lost"])
    ...
    func testJournalCompaction() throws {
        let tempDir = FileManager.default.temporaryDirectory
        let journalPath = tempDir.appendingPathComponent("test-compact-\(UUID().uuidString).sqlite").path
        defer { try? FileManager.default.removeItem(atPath: journalPath) }
    ...
    func testCrossDeviceReconnect() throws {
        let tempDir = FileManager.default.temporaryDirectory
        let journalPath = tempDir.appendingPathComponent("test-crossdevice-\(UUID().uuidString).sqlite").path
        defer { try? FileManager.default.removeItem(atPath: journalPath) }
    ...
    func testMultipleDeviceTransfers() throws {
        let tempDir = FileManager.default.temporaryDirectory
        let journalPath = tempDir.appendingPathComponent("test-multidevice-\(UUID().uuidString).sqlite").path
        defer { try? FileManager.default.removeItem(atPath: journalPath) }
    ...
    func testTransferFailureRecordsError() throws {
        let tempDir = FileManager.default.temporaryDirectory
        let journalPath = tempDir.appendingPathComponent("test-failure-\(UUID().uuidString).sqlite").path
        defer { try? FileManager.default.removeItem(atPath: journalPath) }
        ...
        let errors: [String: Error] = [
            "timeout": NSError(domain: "NetworkError", code: -1001, userInfo: [NSLocalizedDescriptionKey: "The request timed out."]),
            "connection": NSError(domain: "NetworkError", code: -1005, userInfo: [NSLocalizedDescriptionKey: "The network connection was lost."]),
            "space": NSError(domain: "DiskError", code: 28, userInfo: [NSLocalizedDescriptionKey: "No space left on device"])
        ]
    ...
    func testCompletionClearsError() throws {
        let tempDir = FileManager.default.temporaryDirectory
        let journalPath = tempDir.appendingPathComponent("test-clearerror-\(UUID().uuidString).sqlite").path
        defer { try? FileManager.default.removeItem(atPath: journalPath) }
