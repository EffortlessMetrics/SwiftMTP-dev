...
final class DiffEngineIntegrationTests: XCTestCase {
    ...
    func testMTPDiffWithAddedFiles() {
        let addedRows = [
            MTPDiff.Row(handle: 0x20001, storage: 0x10001, pathKey: "DCIM/photo1.jpg", size: 1024, mtime: Date(), format: 0x3801),
            MTPDiff.Row(handle: 0x20002, storage: 0x10001, pathKey: "DCIM/photo2.jpg", size: 2048, mtime: Date(), format: 0x3801),
        ]
    ...
    func testMTPDiffWithModifiedFiles() {
        let modifiedRows = [
            MTPDiff.Row(handle: 0x20001, storage: 0x10001, pathKey: "DCIM/photo1.jpg", size: 2048, mtime: Date(), format: 0x3801),
        ]
    ...
    func testMTPDiffWithMixedChanges() {
        let addedRows = [
            MTPDiff.Row(handle: 0x20004, storage: 0x10001, pathKey: "DCIM/new.jpg", size: 500, mtime: Date(), format: 0x3801),
        ]
        
        let removedRows = [
            MTPDiff.Row(handle: 0x20003, storage: 0x10001, pathKey: "DCIM/delete.txt", size: 300, mtime: Date(), format: 0x3004),
        ]
        
        let modifiedRows = [
            MTPDiff.Row(handle: 0x20002, storage: 0x10001, pathKey: "DCIM/modify.txt", size: 400, mtime: Date(), format: 0x3004),
        ]
