...
final class DeviceIdentityTests: XCTestCase {
    ...
    func testMigrateEphemeralDeviceId() async throws {
        ...
        let oldChildren = try await index.children(deviceId: "04e8:6860@1:3", storageId: 1, parentHandle: nil)
        XCTAssertEqual(oldChildren.count, 0)

        // New domainId should find the migrated object
        let newChildren = try await index.children(deviceId: "stable-uuid-123", storageId: 1, parentHandle: nil)
