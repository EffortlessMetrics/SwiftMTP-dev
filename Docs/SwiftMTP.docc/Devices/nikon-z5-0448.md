...
@Metadata {
    @DisplayName: "Nikon Z5 0448"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Nikon Z5 0448 MTP implementation.
...
- Entry full-frame mirrorless, 24.3 MP.
## Provenance
