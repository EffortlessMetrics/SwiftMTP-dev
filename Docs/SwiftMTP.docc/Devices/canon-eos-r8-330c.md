...
@Metadata {
    @DisplayName: "Canon Eos R8 330C"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Eos R8 330C MTP implementation.
...
- Canon EOS R8 uses PTP over USB.
...
- 24.2 MP entry full-frame mirrorless.
## Provenance
