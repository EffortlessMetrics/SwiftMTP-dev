# Canon Eos Eos M10 32A0

@Metadata {
    @DisplayName: "Canon Eos Eos M10 32A0"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Eos Eos M10 32A0 MTP implementation.
...
- Canon EOS EOS M10 — compact/bridge/mirrorless camera using PTP over USB.
