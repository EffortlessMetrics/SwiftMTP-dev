...
@Metadata {
    @DisplayName: "Nikon Z6 0443"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Nikon Z6 0443 MTP implementation.
...
- Full-frame BSI CMOS, 24.5 MP. Supports GetObjectPropList.
## Provenance
