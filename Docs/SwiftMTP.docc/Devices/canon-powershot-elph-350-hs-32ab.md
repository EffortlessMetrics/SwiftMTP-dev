# Canon Powershot Elph 350 Hs 32Ab

@Metadata {
    @DisplayName: "Canon Powershot Elph 350 Hs 32Ab"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot Elph 350 Hs 32Ab MTP implementation.
...
- Canon PowerShot ELPH 350 HS — compact/bridge/mirrorless camera using PTP over USB.
