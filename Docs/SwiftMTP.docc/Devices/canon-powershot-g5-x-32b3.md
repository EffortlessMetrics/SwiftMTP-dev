# Canon Powershot G5 X 32B3

@Metadata {
    @DisplayName: "Canon Powershot G5 X 32B3"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot G5 X 32B3 MTP implementation.
...
- Canon PowerShot G5 X — compact/bridge/mirrorless camera using PTP over USB.
