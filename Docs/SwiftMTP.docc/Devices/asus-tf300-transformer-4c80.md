# Asus Tf300 Transformer 4C80

@Metadata {
    @DisplayName: "Asus Tf300 Transformer 4C80"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Asus Tf300 Transformer 4C80 MTP implementation.
...
- libmtp: Asus TF300 Transformer (MTP) (DEVICE_FLAGS_ANDROID_BUGS).
