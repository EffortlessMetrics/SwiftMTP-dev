# Canon Powershot Elph 135 3288

@Metadata {
    @DisplayName: "Canon Powershot Elph 135 3288"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot Elph 135 3288 MTP implementation.
...
- Canon PowerShot ELPH 135 — compact/bridge/mirrorless camera using PTP over USB.
