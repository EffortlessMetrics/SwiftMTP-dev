...
@Metadata {
    @DisplayName: "Asus Zenfone2 5600"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Asus Zenfone2 5600 MTP implementation.
...
- libmtp: Asus Zenfone 2 (MTP) (DEVICE_FLAGS_ANDROID_BUGS).
