# Mediatek Mt65Xx Mtp Cdc 2012

@Metadata {
    @DisplayName: "Mediatek Mt65Xx Mtp Cdc 2012"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Mediatek Mt65Xx Mtp Cdc 2012 MTP implementation.
...
- libmtp: MediaTek MT65xx/67xx (MTP+CDC) (DEVICE_FLAGS_ANDROID_BUGS).
