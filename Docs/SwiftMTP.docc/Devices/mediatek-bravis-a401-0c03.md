# Mediatek Bravis A401 0C03

@Metadata {
    @DisplayName: "Mediatek Bravis A401 0C03"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Mediatek Bravis A401 0C03 MTP implementation.
...
- libmtp: Bravis A401 Neo (DEVICE_FLAGS_ANDROID_BUGS).
