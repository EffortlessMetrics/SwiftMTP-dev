...
@Metadata {
    @DisplayName: "Asus Zenfone6 5490"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Asus Zenfone6 5490 MTP implementation.
...
- libmtp: Asus ZenFone 6 (MTP) (DEVICE_FLAGS_ANDROID_BUGS).
