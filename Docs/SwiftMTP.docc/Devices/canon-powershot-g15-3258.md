# Canon Powershot G15 3258

@Metadata {
    @DisplayName: "Canon Powershot G15 3258"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot G15 3258 MTP implementation.
...
- Canon PowerShot G15 — compact/bridge/mirrorless camera using PTP over USB.
