# Canon Powershot Sx720 Hs 32C2

@Metadata {
    @DisplayName: "Canon Powershot Sx720 Hs 32C2"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot Sx720 Hs 32C2 MTP implementation.
...
- Canon PowerShot SX720 HS — compact/bridge/mirrorless camera using PTP over USB.
