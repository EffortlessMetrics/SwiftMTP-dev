# Mediatek Vivo Y21 Ff00

@Metadata {
    @DisplayName: "Mediatek Vivo Y21 Ff00"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Mediatek Vivo Y21 Ff00 MTP implementation.
...
- libmtp: Vivo Y21 (DEVICE_FLAGS_ANDROID_BUGS).
