# Canon Powershot Sx520 Hs 329B

@Metadata {
    @DisplayName: "Canon Powershot Sx520 Hs 329B"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot Sx520 Hs 329B MTP implementation.
...
- Canon PowerShot SX520 HS — compact/bridge/mirrorless camera using PTP over USB.
