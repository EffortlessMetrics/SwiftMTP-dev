# Canon Powershot G16 3274

@Metadata {
    @DisplayName: "Canon Powershot G16 3274"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot G16 3274 MTP implementation.
...
- Canon PowerShot G16 — compact/bridge/mirrorless camera using PTP over USB.
