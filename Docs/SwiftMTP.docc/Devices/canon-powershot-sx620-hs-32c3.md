# Canon Powershot Sx620 Hs 32C3

@Metadata {
    @DisplayName: "Canon Powershot Sx620 Hs 32C3"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot Sx620 Hs 32C3 MTP implementation.
...
- Canon PowerShot SX620 HS — compact/bridge/mirrorless camera using PTP over USB.
