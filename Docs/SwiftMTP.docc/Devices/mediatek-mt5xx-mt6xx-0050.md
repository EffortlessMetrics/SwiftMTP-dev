# Mediatek Mt5Xx Mt6Xx 0050

@Metadata {
    @DisplayName: "Mediatek Mt5Xx Mt6Xx 0050"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Mediatek Mt5Xx Mt6Xx 0050 MTP implementation.
...
- libmtp: MediaTek MT5xx/MT6xx SoCs (DEVICE_FLAGS_ANDROID_BUGS).
