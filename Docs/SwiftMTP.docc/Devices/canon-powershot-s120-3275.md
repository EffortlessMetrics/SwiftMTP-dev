# Canon Powershot S120 3275

@Metadata {
    @DisplayName: "Canon Powershot S120 3275"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot S120 3275 MTP implementation.
...
- Canon PowerShot S120 — compact/bridge/mirrorless camera using PTP over USB.
