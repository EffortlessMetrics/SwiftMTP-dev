# Canon Powershot Elph 340 Hs 3289

@Metadata {
    @DisplayName: "Canon Powershot Elph 340 Hs 3289"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot Elph 340 Hs 3289 MTP implementation.
...
- Canon PowerShot ELPH 340 HS — compact/bridge/mirrorless camera using PTP over USB.
