...
@Metadata {
    @DisplayName: "Nikon Z6 Ii 044C"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Nikon Z6 Ii 044C MTP implementation.
...
- 24.5 MP full-frame second-gen mirrorless.
## Provenance
