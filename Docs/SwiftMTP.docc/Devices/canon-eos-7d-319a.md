...
@Metadata {
    @DisplayName: "Canon Eos 7D 319A"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Eos 7D 319A MTP implementation.
...
- Canon EOS 7D uses PTP over USB.
