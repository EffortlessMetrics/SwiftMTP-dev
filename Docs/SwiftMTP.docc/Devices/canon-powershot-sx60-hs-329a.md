# Canon Powershot Sx60 Hs 329A

@Metadata {
    @DisplayName: "Canon Powershot Sx60 Hs 329A"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot Sx60 Hs 329A MTP implementation.
...
- Canon PowerShot SX60 HS — compact/bridge/mirrorless camera using PTP over USB.
