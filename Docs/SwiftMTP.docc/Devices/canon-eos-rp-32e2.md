...
@Metadata {
    @DisplayName: "Canon Eos Rp 32E2"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Eos Rp 32E2 MTP implementation.
...
- Canon EOS RP uses PTP over USB.
...
- 26.2 MP entry full-frame mirrorless. SD card.
## Provenance
