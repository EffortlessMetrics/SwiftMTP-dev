...
@Metadata {
    @DisplayName: "Nikon Z30 0452"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Nikon Z30 0452 MTP implementation.
...
- Entry-level APS-C mirrorless without EVF, 20.9 MP.
## Provenance
