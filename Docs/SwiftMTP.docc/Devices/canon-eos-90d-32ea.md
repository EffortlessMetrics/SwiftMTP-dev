...
@Metadata {
    @DisplayName: "Canon Eos 90D 32Ea"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Eos 90D 32Ea MTP implementation.
...
- Canon EOS 90D uses PTP over USB.
...
- 32.5 MP APS-C, last major Canon DSLR flagship.
## Provenance
