# Asus Tf700 Transformer 4C90

@Metadata {
    @DisplayName: "Asus Tf700 Transformer 4C90"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Asus Tf700 Transformer 4C90 MTP implementation.
...
- libmtp: Asus TF700 Transformer (MTP) (DEVICE_FLAGS_ANDROID_BUGS).
