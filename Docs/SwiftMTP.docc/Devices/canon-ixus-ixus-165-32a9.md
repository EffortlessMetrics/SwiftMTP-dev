# Canon Ixus Ixus 165 32A9

@Metadata {
    @DisplayName: "Canon Ixus Ixus 165 32A9"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Ixus Ixus 165 32A9 MTP implementation.
...
- Canon IXUS IXUS 165 — compact/bridge/mirrorless camera using PTP over USB.
