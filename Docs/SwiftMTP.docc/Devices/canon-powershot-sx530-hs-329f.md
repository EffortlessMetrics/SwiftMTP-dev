# Canon Powershot Sx530 Hs 329F

@Metadata {
    @DisplayName: "Canon Powershot Sx530 Hs 329F"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot Sx530 Hs 329F MTP implementation.
...
- Canon PowerShot SX530 HS — compact/bridge/mirrorless camera using PTP over USB.
