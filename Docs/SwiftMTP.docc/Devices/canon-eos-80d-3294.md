...
@Metadata {
    @DisplayName: "Canon Eos 80D 3294"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Eos 80D 3294 MTP implementation.
...
- Canon EOS 80D uses PTP over USB.
