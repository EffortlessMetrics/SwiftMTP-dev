# Canon Powershot G3 X 32A8

@Metadata {
    @DisplayName: "Canon Powershot G3 X 32A8"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot G3 X 32A8 MTP implementation.
...
- Canon PowerShot G3 X — compact/bridge/mirrorless camera using PTP over USB.
