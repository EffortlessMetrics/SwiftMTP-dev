...
@Metadata {
    @DisplayName: "Nikon Z7 Ii 044B"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Nikon Z7 Ii 044B MTP implementation.
...
- 45.7 MP full-frame, large NEF Z7II files up to 80 MB.
## Provenance
