...
@Metadata {
    @DisplayName: "Asus Zenfone5 5480"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Asus Zenfone5 5480 MTP implementation.
...
- libmtp: Asus ZenFone 5 (MTP) (DEVICE_FLAGS_ANDROID_BUGS).
