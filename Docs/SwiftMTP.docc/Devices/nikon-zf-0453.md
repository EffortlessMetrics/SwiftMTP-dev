...
@Metadata {
    @DisplayName: "Nikon Zf 0453"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Nikon Zf 0453 MTP implementation.
...
- Retro full-frame mirrorless, 24.5 MP.
## Provenance
