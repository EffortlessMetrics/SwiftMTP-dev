...
@Metadata {
    @DisplayName: "Canon Eos R7 32F7"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Eos R7 32F7 MTP implementation.
...
- Canon EOS R7 uses PTP over USB.
...
- 32.5 MP APS-C mirrorless. Supports GetObjectPropList.
## Provenance
