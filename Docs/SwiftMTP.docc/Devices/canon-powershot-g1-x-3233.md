# Canon Powershot G1 X 3233

@Metadata {
    @DisplayName: "Canon Powershot G1 X 3233"
    @PageKind: article
    @Available: iOS 15.0, macOS 12.0
}

Device-specific configuration for Canon Powershot G1 X 3233 MTP implementation.
...
- Canon PowerShot G1 X — compact/bridge/mirrorless camera using PTP over USB.
