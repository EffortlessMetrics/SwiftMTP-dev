...
"Contribution" means any code, docs, tests, or materials you submit to the Project repository.

## 2. License Grant to Project

You grant the Project a worldwide, perpetual, irrevocable, royalty-free license to:
(a) use, reproduce, modify, and create derivative works of your Contribution;
(b) publicly perform, display, sublicense, and distribute your Contribution and derivative works under any license, including open-source (e.g., AGPL-3.0) and commercial licenses.

## 3. Patent Grant

You grant the Project a perpetual, worldwide, royalty-free patent license to make, use, sell, import, and otherwise practice your Contribution and any combination of your Contribution with the Project, where such license applies only to claims necessarily infringed by your Contribution.
...
The Project may accept, reject, or modify Contributions.
