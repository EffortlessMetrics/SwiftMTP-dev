...
- Wave 66: 100% category coverage — all 5,190+ entries assigned to a device category (0 unknown)
...
- **🎉 Device Quirks Database: 5,190 entries across 289 VIDs and 33 device categories**
...
- **🎉 Device Quirks Database: 5,190 entries across 289 VIDs** (up from 2,055): Massive expansion through waves 11–75:
...
- **Compat matrix**: Regenerated with 5,190 entries and 289 VIDs
